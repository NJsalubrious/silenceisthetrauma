...
json_backup = os.path.join(misc, "profiles_wip.json.bak")
...
# 1. Parse JSON backup for avatar paths
try:
...
# 2. Parse Markdown to map characters to websites
...
for block in blocks:
    ...
    if website and is_missing:
        # Try to match the website name to a JSON id (e.g. marcus_vane.html -> marcus_vane)
        ...
        if old_avatar:
            ...
            # Search in old_avitar_and_posting_images and misc folders
            search_dirs = [
                old_avatar_dir,
