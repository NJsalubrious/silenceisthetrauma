...
manual_map = {
    "Davo the Crane Driver": "davo-the-crane-driver-avatar.jpg",
    "Dr. Aris Vokos": "dr-aris-vokos-avatar.jpg",
    "Mrs. Liu": "mrs-liu-avatar.jpg",
    "Father Mateo": "father-mateo-avatar.jpg",
    "Angus Dunbar (PI)": "angus-dunbar-avatar.jpg",
...
print(f"Manually mapped and updated {updated_count} avatars in MASTER_Final_Network.md")
